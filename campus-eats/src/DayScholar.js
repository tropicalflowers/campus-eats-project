          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-4">
              ...
              <div className="hidden sm:flex items-center gap-2">
                <span className={`text-sm ${isLightMode ? 'text-orange-500/70' : 'text-blue-400/70'}`}>Day Scholar</span>
                {user?.email && (
                  <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          <div className={`lg:col-span-2 ${cardClass} border rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300`}>
            ...
            <h1 className={`text-5xl font-extrabold mb-4 ${isLightMode ? 'bg-gradient-to-r from-orange-500/80 via-rose-500/80 to-amber-500/80' : 'bg-gradient-to-r from-blue-500/80 via-cyan-500/80 to-teal-500/80'} bg-clip-text text-transparent`}>Fastest Campus Ordering</h1>
            <p className={`text-lg mb-6 ${isLightMode ? 'text-gray-600' : 'text-slate-300'}`}>
              Order from dozens of curated campus restaurants and cafés for quick pickup.
            </p>
            <button onClick={() => window.scrollTo({ top: 400, behavior: 'smooth' })} className={`${isLightMode ? 'bg-gradient-to-r from-orange-400/80 via-rose-400/80 to-amber-400/80 hover:from-orange-500/80 hover:via-rose-500/80 hover:to-amber-500/80' : 'bg-gradient-to-r from-blue-500/80 via-cyan-500/80 to-teal-500/80 hover:from-blue-600/80 hover:via-cyan-600/80 hover:to-teal-600/80'} text-white px-8 py-4 rounded-xl font-bold transition-all shadow-lg hover:shadow-xl`}>
              Start Ordering 🚀
            </button>
          </div>
        ...
        <section className="mt-16">
          <h2 className={`text-4xl font-bold mb-8 flex items-center gap-3 ${textClass}`}>
            <span className="bg-gradient-to-r from-emerald-500/80 via-teal-500/80 to-cyan-500/80 bg-clip-text text-transparent">📦 My Orders</span>
